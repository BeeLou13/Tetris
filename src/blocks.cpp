...
public:
    SBlock()
    {
        ...
        cells[2] = {Position(2,0), Position(1,1), Position(2,1), Position(1,2)};
...
public:
    TBlock()
    {
        ...
        cells[1] = {Position(0,1), Position(2,1), Position(1,2), Position(1,1)};
        cells[2] = {Position(1,2), Position(1,0), Position(2,1), Position(1,1)};
...
public:
    ZBlock()
    {
        ...
        cells[2] = {Position(2,1), Position(2,2), Position(1,0), Position(1,1)};
